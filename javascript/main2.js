...
const user1 = {
  ...
  projects: [
    ...
    },
    {
      name: "Medium Clone",
      description:
        "Medium web sitesinin hazırlamış olduğum clone versiyonudur.",
    ...
    },
    {
      ...
      description:
        "andex Translate Api'sini kullanarak hazırlamış olduğum, kullanıcıların üç farklı dilde çeviri yapmasını sağlayan bir uygulamadır.",
      technologies: "HTML, CSS, Bootstrap, Javascript",
    ...
    },
    {
      ...
      description:
        "Rest Api ve Fetch yapılarını kullanarak hazırlamış olduğum döviz çeviri uygulamasıdır.",
    ...
    },
    {
      ...
      description:
        "Kullanıcı adı girilen Github kullanıcısının profil bilgilerini ve repo bilgilerini ekrana getiren Github Rest Api'sinin kullanıldığı bir uygulamadır.",
      technologies: "HTML, CSS, Bootstrap, Javascript",
    ...
    },
    {
      ...
      description:
        "Javascript ES6 Class yapsını kullanarak hazırlamış olduğum, kullanıcıların film bilgilerini girdikten sonra ekranda filmi ekranda görüntülemesini ve filmlerin local storage kaydedilerek kaybolmamasını sağlayan bir uygulamadır.",
      technologies: "HTML, CSS, Bootstrap, Javascript",
...
const user2 = {
  name: "Hicabi Yılmaz",
  profilePhoto:
    "https://pbs.twimg.com/profile_images/1243852813391798273/fOzBwZB7_400x400.jpg",
  description:
    "Merhaba, ben Hicabi. 29 yaşındayım. Frontend Developer olmak için çalışıyorum. Patika.dev üzerinden Frontend Patikasını takip ediyorum. Şu an React öğreniyorum. Öğrenmek benim için bir tutku. ",
  projects: [
    {
      name: "React TodoList",
      description:
    ...
    },
    {
      ...
      description:
        "Patika.dev ödevi olarak hazırlamış olduğum Instagram Clone.",
...
const user3 = {
  name: "Hasret Bayar",
  profilePhoto:
    "https://scontent.fist15-1.fna.fbcdn.net/v/t39.30808-6/246629020_5023908354304809_1293860839732677461_n.jpg?_nc_cat=102&ccb=1-5&_nc_sid=09cbfe&_nc_ohc=qikIueoBkA8AX_Vvqln&_nc_ht=scontent.fist15-1.fna&oh=47bda3658ec15c5dea9c574c3d364b05&oe=6179434C",
  description:
    "Projelerimi aşağıdan inceleyebilirsiniz.. Hakkımda daha detaylı bilgi için sosyal medya hesaplarımdan iletişime geçebilirsiniz.",
  projects: [
    {
      name: "TodoList",
      description:
    ...
    },
    {
      name: "Linkedin Clone",
      description:
        "Linkedin web sitesinin hazırlamış olduğum clone versiyonudur.",
      technologies: "HTML, CSS, Bootstrap",
    ...
    },
    {
      ...
      description:
        "Javascript ile saatin ve günün gösterildiği bir websitesi yaptım.",
      technologies: "HTML, CSS, Javascript",
